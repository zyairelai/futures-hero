...
def GO_LONG(one_minute, five_minute, one_hour):
    if ((one_minute == "GREEN") and (one_minute_entry_test("GREEN"))) and \
       (((five_minute == "GREEN") or (five_minute == "GREEN_INDECISIVE")) and (five_minute_test("GREEN"))) and \
       ((one_hour != "RED" or one_hour != "RED_INDECISIVE") and not (one_hour_test("RED"))): return True
    else: return False

def GO_SHORT(one_minute, five_minute, one_hour):
    if ((one_minute == "RED") and (one_minute_entry_test("RED"))) and \
       (((five_minute == "RED") or (five_minute == "RED_INDECISIVE")) and (five_minute_test("RED")))\
       ((one_hour != "GREEN" or one_hour != "GREEN_INDECISIVE") and not (one_hour_test("GREEN"))): return True
    else: return False
...
def DIRECTION_CHANGE_EXIT_LONG(one_hour, six_hour):
    if ((one_hour == "RED") and (one_hour_test("RED"))) or \
       ((one_hour == "RED_INDECISIVE") and (check_previous("1HOUR") == "GREEN")) and (one_hour_test("RED")) or \
       ((six_hour == "RED") and ((one_hour == "RED") or (one_hour == "RED_INDECISIVE")) and one_hour_test("RED")): return True
    else: return False

def DIRECTION_CHANGE_EXIT_SHORT(one_hour, six_hour):
    if ((one_hour == "GREEN") and (one_hour_test("GREEN"))) or \
       ((one_hour == "GREEN_INDECISIVE") and (check_previous("1HOUR") == "RED") and (one_hour_test("GREEN"))) or \
       ((six_hour == "GREEN") and ((one_hour == "GREEN") or (one_hour == "GREEN_INDECISIVE")) and one_hour_test("GREEN")): return True
    else: return False
