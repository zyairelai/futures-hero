...
def get_3_minute(): # >>> "UP" // "DOWN" // "INDECISIVE"
    ...
    if heikin_ashi_candle == "UP": print("recent 3 minute  :   🥦 GREEN 🥦")
    elif heikin_ashi_candle == "DOWN": print("recent 3 minute  :   🩸 RED 🩸")
    else: print("recent 3 minute  :   😴 INDECISIVE 😴")
...
def get_5_minute(): # >>> "UP" // "DOWN" // "INDECISIVE"
    ...
    heikin_ashi_candle = heikin_ashi(klines)
    if heikin_ashi_candle == "UP": print("recent 5 minute  :   🥦 GREEN 🥦")
    elif heikin_ashi_candle == "DOWN": print("recent 5 minute  :   🩸 RED 🩸")
    else: print("recent 5 minute  :   😴 INDECISIVE 😴")
    return heikin_ashi_candle
...
def get_15_minute(): # >>> "UP" // "DOWN" // "INDECISIVE"
    ...
    heikin_ashi_candle = heikin_ashi(klines)
    if heikin_ashi_candle == "UP": print("recent 15 minute :   🥦 GREEN 🥦")
    elif heikin_ashi_candle == "DOWN": print("recent 15 minute :   🩸 RED 🩸")
    else: print("recent 15 minute :   😴 INDECISIVE 😴")
    return heikin_ashi_candle
...
def get_1_hour(): # >>> "UP" // "DOWN" // "INDECISIVE"
    ...
    heikin_ashi_candle = heikin_ashi(klines)
    if heikin_ashi_candle == "UP": print("1 HOUR DIRECTION :   🥦 GREEN 🥦")
    elif heikin_ashi_candle == "DOWN": print("1 HOUR DIRECTION :   🩸 RED 🩸")
    else: print("1 HOUR DIRECTION :   😴 INDECISIVE 😴")
    return heikin_ashi_candle
...
def get_4_hour(): # >>> "UP" // "DOWN" // "INDECISIVE"
    ...
    heikin_ashi_candle = heikin_ashi(klines)
    if heikin_ashi_candle == "UP": print("4 HOUR DIRECTION :   🥦 GREEN 🥦")
    elif heikin_ashi_candle == "DOWN": print("4 HOUR DIRECTION :   🩸 RED 🩸")
    else: print("4 HOUR DIRECTION :   😴 INDECISIVE 😴")
    return heikin_ashi_candle
...
def get_6_hour(): # >>> "UP" // "DOWN" // "INDECISIVE"
    ...
    heikin_ashi_candle = heikin_ashi(klines)
    if heikin_ashi_candle == "UP": print("6 HOUR DIRECTION :   🥦 GREEN 🥦")
    elif heikin_ashi_candle == "DOWN": print("6 HOUR DIRECTION :   🩸 RED 🩸")
    else: print("6 HOUR DIRECTION :   😴 INDECISIVE 😴")
    return heikin_ashi_candle
