...
def lets_make_some_money(i):
    ...
    if position_info == "LONGING":
        ...
        if current_trend == "GREEN" and not direction.hot_zone(klines_30MIN, klines_6HOUR) and place_order.GO_LONG_EMA(mark_price, klines_1min, klines_1HOUR):
        ...
        elif current_trend == "RED" and not direction.hot_zone(klines_30MIN, klines_6HOUR) and place_order.GO_SHORT_EMA(mark_price, klines_1min, klines_1HOUR):
