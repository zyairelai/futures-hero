...
def dead_or_alive():
    ...
    if position_info == "LONGING":
        if  ((six_hour == "RED") or (six_hour == "RED_INDECISIVE")) or ((get_position.get_unRealizedProfit() == "PROFIT") and CLOSE_LONG()) or DIRECTION_CHANGE_EXIT_LONG(one_hour, previous_volume, current_volume):
            print("ACTION           :   💰 CLOSE_LONG 💰")
            binance_futures.close_position("LONG")
        else: print(colored("ACTION           :   HOLDING_LONG", "green"))

    elif position_info == "SHORTING":
        if  ((six_hour == "GREEN") or (six_hour == "GREEN_INDECISIVE")) or ((get_position.get_unRealizedProfit() == "PROFIT") and CLOSE_SHORT()) or DIRECTION_CHANGE_EXIT_SHORT(one_hour, previous_volume, current_volume):
